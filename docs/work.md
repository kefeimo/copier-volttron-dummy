...
├── 📁 python_package_distribution_name  ------------------------ # the source code directory
...
Now you can start writing and editing code in `{{python_package_distribution_name}}/your_package`.
...
```python
# {{python_package_distribution_name}}/your_package/module.py
import subprocess
```
...
✗ Checking code quality (1)
  > flake8 --config=config/flake8.ini {{python_package_distribution_name}}/ tests/ scripts/
  {{python_package_distribution_name}}/your_package/module.py:2:1: S404 Consider possible security implications associated with subprocess module.
```
...
per-file-ignores =
    ...
    {{python_package_distribution_name}}/your_package/__init__.py:F401
    ; continuation line under-indented for hanging indent
    setup.py:E121
    ; mutable constant
    {{python_package_distribution_name}}/your_package/your_module.py:WPS407
```
...
--------------------------------------------------------
{{python_package_distribution_name}}/duty/cli.py        62      0     20      0   100.00%
{{python_package_distribution_name}}/duty/logic.py      71      0     18      0   100.00%
--------------------------------------------------------
