...
```
    ...
    create  {{python_package_distribution_name}}/
    create  {{python_package_distribution_name}}/my_project/
    create  {{python_package_distribution_name}}/my_project/cli.py
    create  {{python_package_distribution_name}}/my_project/__main__.py
    create  {{python_package_distribution_name}}/my_project/__init__.py
    create  scripts/
